...
def plot_beadmaps():
    ...
    ax2.imshow(precision_residues['1'],cmap='hot',interpolation='nearest',aspect='auto',extent=[min(residue_range),max(residue_range)+1,0,0.5],norm=matplotlib.colors.Normalize(vmin=min_precision,vmax=max_precision))
    ax2.vlines(bead_boxes['1'],ymin=0,ymax=0.5,colors='black',linestyles='dotted',linewidth=0.1)
    ax2.set_xlim(min(residue_range), max(residue_range)+1)
    ax2.set_xticks([])
    ax2.set_yticks([])
    ...
    ax3.imshow(precision_residues['5'],cmap='hot',interpolation='nearest',aspect='auto',extent=[min(residue_range),max(residue_range)+1,0,0.5],norm=matplotlib.colors.Normalize(vmin=min_precision,vmax=max_precision))
    ax3.vlines(bead_boxes['5'],ymin=0,ymax=0.5,colors='black',linestyles='dotted',linewidth=0.1)
    ax3.set_xlim(min(residue_range), max(residue_range)+1)
    ax3.set_xticks([])
    ax3.set_yticks([])
    
    ax4 = fig.add_subplot(6,1,4)
    ax4.imshow(precision_residues['10'],cmap='hot',interpolation='nearest',aspect='auto',extent=[min(residue_range),max(residue_range)+1,0,0.5],norm=matplotlib.colors.Normalize(vmin=min_precision,vmax=max_precision))
    ax4.vlines(bead_boxes['10'],ymin=0,ymax=0.5,colors='black',linestyles='dotted',linewidth=0.1)
    ...
    ax5.imshow(precision_residues['20'],cmap='hot',interpolation='nearest',aspect='auto',extent=[min(residue_range),max(residue_range)+1,0,0.5],norm=matplotlib.colors.Normalize(vmin=min_precision,vmax=max_precision))
    ax5.vlines(bead_boxes['20'],ymin=0,ymax=0.5,colors='black',linestyles='dotted',linewidth=0.1)
