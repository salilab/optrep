...
def parse_args():
    ...
    parser.add_argument("-cl","--criteria_list",nargs='+',type=str,dest="criteria_list",help="list of criteria")
    parser.add_argument("-kl","--keywords_list",nargs='+',type=str,dest="keywords_list",help="list of stat file keywords")
    parser.add_argument("-agl","--aggregate_lower_thresholds",nargs='+',type=float,dest="aggregate_lower_thresholds",help="aggregate lower threshold values")
    parser.add_argument("-aul","--aggregate_upper_thresholds",nargs='+',type=float,dest="aggregate_upper_thresholds",help="aggregate upper threshold values")
